...
import 'package:intinow/adminPanel/admin_index_page.dart';
...
import 'package:intinow/adminPanel/adminProfileManagement/user_details_admin.dart';
import 'package:intinow/authentication/login_screen_admin.dart';
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            _customListTile(context, Icons.event, 'Events'),
  ...
  Widget _customListTile(BuildContext context, IconData icon, String text) {
    return TextButton(
      ...
      onPressed: () {
        ...
        if (text == 'Events') {
          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => AdminManageEventsPage()));
        }
