...
import 'package:intinow/adminPanel/services/faculties.dart';
import 'dart:io';
import 'dart:math';
...
class _CreateEventPageState extends State<CreateEventPage> {
                        ...
                        onPressed: () async {
                          ...
                          if (currentUser == null) {
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                              content:
                                  Text('Please sign in to create an event.'),
  ...
  Future<void> _createEvent(User currentUser) async {
    try {
      ...
      String imageUrl =
          'https://firebasestorage.googleapis.com/v0/b/intinow.appspot.com/o/placeholders%2FeventImagePlaceholder.png?alt=media&token=e59ec9ec-15b9-4350-b8fe-4b885d8765ea';
      if (_eventImage != null) {
        final String imageFileName =
            'event_image_${now.microsecondsSinceEpoch}.jpg';
        final Reference storageReference =
            _storage.ref().child('event_images/$imageFileName');
