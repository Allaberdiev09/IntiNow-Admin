...
class EditAdminDetailsPage extends StatefulWidget {
  final DocumentReference userReference;
  EditAdminDetailsPage({required this.userReference});

  @override
  _EditAdminDetailsPageState createState() => _EditAdminDetailsPageState();
}

class _EditAdminDetailsPageState extends State<EditAdminDetailsPage> {
