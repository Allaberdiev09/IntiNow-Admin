...
import 'package:intinow/adminPanel/services/admin_credentials.dart';
...
class _CreateUsersPageState extends State<CreateUsersPage> {
  ...
  String _userRole = 'Authorized User';
  final List<String> _userRoles = ['Authorized User', 'Student'];
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                if (_userRole == 'Authorized User' || _userRole == 'Student')
                  OutlinedButton(
                    onPressed: () {
